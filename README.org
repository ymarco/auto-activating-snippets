...
(If you want more LaTeX snippets, take a look at [[TODO][LaTeX-auto-activating-snippets]])
...
[[TODO][LaTeX-auto-activating-snippets]] were 'inspired' by cdlatex, replacing ~`~ as a
prefix by ~;~.
